                    ...
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" action="/user_save" method="post">
                            <div class="box-body">
                                ...
                                <div class="col-sm-10">
                                    <input style="width: 30%" type="email" class="form-control" name="email" id="inputEmail3" <c:if test="${ReUser.email!=null}">value="${ReUser.email}"</c:if> placeholder="Email">
                                </div>
                            </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input style="width: 30%" type="password" class="form-control" name="password" id="inputPassword3" <c:if test="${ReUser.password!=null}">value="${ReUser.password}"</c:if> placeholder="Password">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="box-footer">
                                ...
                                <button type="button" class="btn btn-default" id="returnBe" onclick="window.location.href=document.referrer">返回上一级</button>
