                        ...
                        <div class="row" >
                            ...
                            <div class="col-md-6" style="padding-left: 150px">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        <li><a href="/bill_search?pn=1&billType=${billType}&billTaker=${billTaker}">首页</a> </li>
                                        <%--如果有上一页，则可以通过减一操作移动，且有<符号&laquo，否则连点<的符号也没有，也就不能移动上一页--%>
                                        <c:if test="${pageInfo.hasPreviousPage}">
                                            <li>
                                                <a href="/bill_search?pn=${pageInfo.pageNum-1}&billType=${billType}&billTaker=${billTaker}" aria-label="Previous">
                                        ...
                                        <c:forEach items="${pageInfo.navigatepageNums}" var="page_Num">
                                            ...
                                            <c:if test="${page_Num!=pageInfo.pageNum}">
                                                <li><a href="/bill_search?pn=${page_Num}&billType=${billType}&billTaker=${billTaker}">${page_Num}</a></li>
                                            </c:if>

                                        </c:forEach>
                                        <c:if test="${pageInfo.hasNextPage}">
                                            <li>
                                                <a href="/bill_search?pn=${pageInfo.pageNum+1}&billType=${billType}&billTaker=${billTaker}" aria-label="Next">
                                                    <span aria-hidden="true">&raquo;</span>
                                                </a>
                                            </li>
                                        </c:if>

                                        <li><a href="/bill_search?pn=${pageInfo.pages}&billType=${billType}&billTaker=${billTaker}">末页</a> </li>
