                        ...
                        <form class="form-horizontal" action="/waybill_save" method="post">
                            <div class="box-body col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="waybillId" value="${waybill.waybillId}" class="col-sm-2" placeholder="请输入编号">
                                    <label class="col-sm-2 control-label">托运日期：</label>
                                    <div  class="col-sm-2 input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input type="text" value="<fmt:formatDate value="${waybill.waybillDate}" pattern="yyyy-MM-dd"></fmt:formatDate>" name="waybillDate" class="form-control pull-right" id="waybillDate">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="waybillBegin" class=" col-sm-2 " placeholder="请输入起点站" value="${waybill.waybillBegin}">
                                <label class="col-sm-2 control-label"> 到达站：</label>
                                <input type="text"  name="waybillEnd" class=" col-sm-2 " placeholder="请输入终点站" value="${waybill.waybillEnd}">
                            </div>

                            <div class="form-group">

                                <label class="col-sm-2 control-label"> 收货客户：</label>
                                <input type="text"  name="waybillRecive" class=" col-sm-2 " placeholder="请输入收货客户" value="${waybill.waybillRecive}">
                                <label class="col-sm-2 control-label"> 收货客户地址：</label>
                                <input type="text" class="col-sm-2" name="waybillReciveAddress" placeholder="请输入地址" value="${waybill.waybillReciveAddress}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="col-sm-2" name="waybillRecivePhone" placeholder="请输入号码" value="${waybill.waybillRecivePhone}">

                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> 发货客户：</label>
                                <input type="text"  name="waybillSend" class=" col-sm-2 " placeholder="请输入发货客户" value="${waybill.waybillSend}">
                                <label class="col-sm-2 control-label"> 发货客户地址：</label>
                                <input type="text" class="col-sm-2" name="waybillSendAddress" placeholder="请输入地址"value="${waybill.waybillSendAddress}">
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label"> 发货客户电话：</label>
                                <input type="text" class="col-sm-2" name="waybillSendPhone" placeholder="请输入号码" value="${waybill.waybillSendPhone}">
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> 代收贷款：</label>
                                <input type="text" class="col-sm-2" name="waybillLoan" placeholder="请输入贷款" value="${waybill.waybillLoan}">
                                <label class="col-sm-2 control-label"> 代收佣金率：</label>
                                <input type="text" class="col-sm-2" name="waybillCommission" placeholder="请输入佣金率" value="${waybill.waybillCommission}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="waybillFreight" class="col-sm-2" placeholder="请输入金额" value="${waybill.waybillFreight}">
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">保险费：</label>
                                <input type="text" name="waybillInsurance" class="col-sm-2" placeholder="请输入金额" value="${waybill.waybillInsurance}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="waybillFill" value="${waybill.waybillFill}" class="col-sm-2" placeholder="请输入填票人">

                            </div>
                            <div class="form-group">

                                <label class="col-sm-2 control-label">付回扣：</label>
                                <input type="text" name="waybillRebate" class="col-sm-2" placeholder="请输入金额" value="${waybill.waybillRebate}">
                                <label class="col-sm-2 control-label">填票日期：</label>
                                <div  class="col-sm-2 input-group date">
                                    <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </div>
                                    <input type="text" value="<fmt:formatDate value="${waybill.waybillFillDate}" pattern="yyyy-MM-dd"></fmt:formatDate>" name="waybillFillDate" class="form-control pull-right" id="waybillFillDate">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> 备注：</label>
                                <textarea style="height:72px;width:680px" maxlength="255" name="waybillRemarks" placeholder="请输入备注">${waybill.waybillRemarks}</textarea>
                            </div>
                                <div class="box-footer">
                                    ...
                                    <div class="row" style="padding-left: 600px; padding-top: 10px">
                                        ...
                                        <button type="submit" class="btn bnt-sm btn-default"><i class="fa fa-plus"></i>修改</button>&nbsp&nbsp&nbsp
